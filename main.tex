...
\item HLB101: This is part of the newest building on campus: Highland Hall. It's the only lecture hall in the entire building, located at the lowest level and by the gender neutral washrooms.
...
\begin{itemize}
    \item \textbf{HL170:} This is where most of the midterms and finals take place. More formal events also take place in here such as TED talks, club-specific events, and networking events for co-op.
...
\begin{itemize}
    ...
    \item And to round up the food on campus, there is the new cafe in the new Highland Hall, Gathering Grounds! It's a pretty standard "cafe" not too different from Tim's but they do have flatbread pizzas. \par
